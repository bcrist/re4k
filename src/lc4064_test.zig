...
pub fn main() !void {
    ...
    try design.pinAssignment(.{ .signal = "a0", .pin_index = 90, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a1", .pin_index = 91, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a2", .pin_index = 92, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a3", .pin_index = 93, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a4", .pin_index = 96, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a5", .pin_index = 97, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a6", .pin_index = 98, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a7", .pin_index = 99, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a8", .pin_index = 2,   .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a9", .pin_index = 3,   .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a10", .pin_index = 4,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a11", .pin_index = 5,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a12", .pin_index = 7,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a13", .pin_index = 8,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a14", .pin_index = 9,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "a15", .pin_index = 10, .init_state = 0 });

    try design.pinAssignment(.{ .signal = "b0", .pin_index = 36, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b1", .pin_index = 35, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b2", .pin_index = 34, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b3", .pin_index = 33, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b4", .pin_index = 30, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b5", .pin_index = 29, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b6", .pin_index = 28, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b7", .pin_index = 27, .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b8", .pin_index = 21,   .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b9", .pin_index = 20,   .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b10", .pin_index = 19,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b11", .pin_index = 18,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b12", .pin_index = 16,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b13", .pin_index = 15,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b14", .pin_index = 14,  .init_state = 0 });
    try design.pinAssignment(.{ .signal = "b15", .pin_index = 13, .init_state = 0 });

    try design.pinAssignment(.{ .signal = "clk", .pin_index = 11, });
    try design.pinAssignment(.{ .signal = "dir", .pin_index = 40, .init_state = 1 });
