...
fn runToolchain(ta: std.mem.Allocator, tc: *Toolchain, dev: DeviceType, mcref: core.MacrocellRef, init_state: u1) !toolchain.FitResults {
    ...
    try helper.logResults("init_state_glb{}_mc{}_{}", .{ mcref.glb, mcref.mc, init_state }, results);
