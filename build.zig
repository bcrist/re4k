...
fn make_exe(b: *std.Build, ctx: anytype, comptime name: []const u8) void {
    ...
    exe.root_module.addImport("lc4k", ctx.lc4k);
    exe.root_module.addImport("sx", ctx.sx);
    exe.root_module.addImport("Temp_Allocator", ctx.Temp_Allocator);
